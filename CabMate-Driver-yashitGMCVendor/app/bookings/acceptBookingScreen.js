...
const AcceptBookingFormScreen = () => {
  ...
  //   dynamic form field
  function acceptBookingInfo(booking) {
    return (
      <View style={{ marginTop: 20 }}>
        <View style={styles.container}>
          {/* booking status */}
          <View style={[styles.headerRow, { justifyContent: "flex-end" }]}>
            <Text style={styles.bookingStatus}>Accepted</Text>
          </View>
...
export default AcceptBookingFormScreen;
